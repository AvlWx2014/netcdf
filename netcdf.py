...
class NetCDFWriter(netCDF4.Dataset, object):
    """Consolidate functionality to write netCDF files.
    ...
    **kwargs
    ...
    def create_time_variable(self, name, time, **kwargs):
        ...
        First calls ``_create_time_dimension``, which is responsible for 
        setting up the reference dimension for the time variable.
        ...
        **kwargs
            ...
            will become the attribute values. Time units are seconds since 
            the epoch unless a `units` keyword argument is present.
    ...
    def create_data_variable(self, name, dims, data, **kwargs):
        ...
        data : :obj:`numpy.ndarray`
            ...
            fill value of -999.0 will be assigned as an attribute to this
        ...
        **kwargs
        ...
        ValueError
            If a given dimension name does not exist in the current file. A
            side effect of this is that the client must create any needed
            reference dimensions prior to creating the data variable in their
            code.
    ...
    def create_extra_variables(self, names, dims, data, **kwargs):
        ...
        **kwargs
        ...
        for name, datum, dim in zip(names, dims, data):
            self.createVariable(
                name,
                datum.dtype,
                dim,
    ...
    def set_global_attributes(self, **kwargs):
        ...
        **kwargs
        ...
        """
        self.setncattr("conventions", "CF-1.7")
